...
#define Y_STEP_PIN (byte)4
#define Y_DIR_PIN (byte)5
...
//extruder pins
#define EXTRUDER_0_MOTOR_SPEED_PIN  (byte)10 //needs to be 3 5 6 9 10 or 11
#define EXTRUDER_0_MOTOR_DIR_PIN    (byte)18
...
//heated bed
#define BED_TEMPERATURE_PIN      (byte)5 // Analogue input
#define BED_HEATER_PIN_1         (byte)11 //pwm3
#define BED_HEATER_PIN_2         (byte)13 //pwm2
#endif
#endif
